...
void HAL_SPI_MspInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  */
    ...
    PE14     ------> SPI4_MOSI
    */
    GPIO_InitStruct.Pin = SD_SPI_MISO_Pin|SD_SPI_CLK_Pin|SD_SPI_MOSI_Pin;
  ...
  */
    ...
    PF8     ------> SPI5_MISO
    */
    GPIO_InitStruct.Pin = IMU_SPI_MOSI_Pin|IMU_SPI_CLK_Pin|IMU_SPI_MISO_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_MEDIUM;
    ...
    /* SPI5 DMA Init */
    /* SPI5_TX Init */
    hdma_spi5_tx.Instance = DMA2_Stream2;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  /* USER CODE END SPI4_MspDeInit 0 */
    ...
    PE14     ------> SPI4_MOSI
    */
    HAL_GPIO_DeInit(GPIOE, SD_SPI_MISO_Pin|SD_SPI_CLK_Pin|SD_SPI_MOSI_Pin);
  ...
  /* USER CODE END SPI5_MspDeInit 0 */
    ...
    PF8     ------> SPI5_MISO
    */
    HAL_GPIO_DeInit(GPIOF, IMU_SPI_MOSI_Pin|IMU_SPI_CLK_Pin|IMU_SPI_MISO_Pin);
